...
export default function ProjectCard({ title, desc, img, index }: ProjectCardProps) {
  ...
  return (
    <div
      className="bg-[#232323] rounded-xl p-4 border border-[#232323] flex flex-col h-64 transition hover:shadow-lg"
      style={{
